...
Snapshot date: **2026-09-15**. This is a miner setup matrix, not a buyer product
...
OpenRouter is a broker rather than a host, so its routes carry an extra
condition: the image proves at boot that the account keeps no copy of a prompt
it served, re-proves it every 15 minutes, and attempts to read back every
generation it serves; a stored prompt takes the whole worker offline. It carries
only the closed model list compiled into the measured image. See
[sourcing.md](sourcing.md#openrouter-prompt-retention-enforcement).
...
|---|---|
| `claude-fable-5` | Anthropic API: `anthropic/claude-fable-5` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-fable-5` (`--openrouter`) |
| `claude-fable-5-1` | Anthropic API: `anthropic/claude-fable-5-1` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-fable-5.1` (`--openrouter`) |
| `claude-haiku-4-5` | Anthropic API: `anthropic/claude-haiku-4-5` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-haiku-4.5` (`--openrouter`) |
| `claude-opus-4-6` | Anthropic API: `anthropic/claude-opus-4-6` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-opus-4.6` (`--openrouter`) |
| `claude-opus-4-7` | Anthropic API: `anthropic/claude-opus-4-7` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-opus-4.7` (`--openrouter`) |
| `claude-opus-4-8` | Anthropic API: `anthropic/claude-opus-4-8` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-opus-4.8` (`--openrouter`) |
| `claude-opus-5` | Anthropic API: `anthropic/claude-opus-5` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-opus-5` (`--openrouter`) |
| `claude-sonnet-4-6` | Anthropic API: `anthropic/claude-sonnet-4-6` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-sonnet-4.6` (`--openrouter`) |
| `claude-sonnet-5` | Anthropic API: `anthropic/claude-sonnet-5` (`--anthropic`); Microsoft Foundry: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/anthropic/claude-sonnet-5` (`--openrouter`) |
| `DeepSeek V3.2 TEE` | Chutes: `chutes/deepseek-ai/DeepSeek-V3.2-TEE` (`--chutes`) |
| `DeepSeek V4 Flash 0731` | KubeTEE: `kubetee/deepseek/deepseek-v4-flash-0731` (`--kubetee`); Engy: `engy/deepseek-v4-flash-0731` (`--engy`); DeepInfra: `deepinfra/deepseek-ai/DeepSeek-V4-Flash-0731` (`--deepinfra`); OpenRouter: `openrouter/deepseek/deepseek-v4-flash-0731` (`--openrouter`) |
| `DeepSeek V4.1 Flash` | KubeTEE: `kubetee/deepseek/deepseek-v4.1-flash` (`--kubetee`); DeepInfra: `deepinfra/deepseek-ai/DeepSeek-V4.1-Flash` (`--deepinfra`); Engy: `engy/deepseek-v4.1-flash` (`--engy`); OpenRouter: `openrouter/deepseek/deepseek-v4.1-flash` (`--openrouter`) |
...
| `GLM-5.2` | Z.ai API: `zai/glm-5.2` (`--zai`); DeepInfra: `deepinfra/zai-org/GLM-5.2` (`--deepinfra`); Engy: `engy/glm-5.2` (`--engy`); KubeTEE: `kubetee/z-ai/glm-5.2` (`--kubetee`); Moonmath ZRO: `moonmath/glm-5.2` (`--moonmath`); OpenRouter: `openrouter/z-ai/glm-5.2` (`--openrouter`) |
| `GLM-5.2 TEE` | Chutes: `chutes/zai-org/GLM-5.2-TEE` (`--chutes`); NEAR confidential inference: `near/z-ai/glm-5.2` (`--near`) |
| `GLM-5.3` | Z.ai API: `zai/glm-5.3` (`--zai`); KubeTEE: `kubetee/z-ai/glm-5.3` (`--kubetee`); Engy: `engy/glm-5.3` (`--engy`); OpenRouter: `openrouter/z-ai/glm-5.3` (`--openrouter`) |
| `GLM-5.3-Flash` | Z.ai API: `zai/glm-5.3-flash` (`--zai`); KubeTEE: `kubetee/z-ai/glm-5.3-flash` (`--kubetee`); Engy: `engy/glm-5.3-flash` (`--engy`); OpenRouter: `openrouter/z-ai/glm-5.3-flash` (`--openrouter`) |
| `GPT-5.4` | OpenAI API: `openai/gpt-5.4` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.4` (`--openrouter`) |
| `GPT-5.4 mini` | OpenAI API: `openai/gpt-5.4-mini` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.4-mini` (`--openrouter`) |
| `GPT-5.4 nano` | OpenAI API: `openai/gpt-5.4-nano` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.4-nano` (`--openrouter`) |
| `GPT-5.5` | OpenAI API: `openai/gpt-5.5` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.5` (`--openrouter`) |
| `GPT-5.5 Pro` | OpenAI API: `openai/gpt-5.5-pro` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.5-pro` (`--openrouter`) |
| `GPT-5.6` | OpenAI API: `openai/gpt-5.6` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission |
| `GPT-5.6 Luna` | OpenAI API: `openai/gpt-5.6-luna` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.6-luna` (`--openrouter`) |
| `GPT-5.6 Sol` | OpenAI API: `openai/gpt-5.6-sol` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.6-sol` (`--openrouter`) |
| `GPT-5.6 Terra` | OpenAI API: `openai/gpt-5.6-terra` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/gpt-5.6-terra` (`--openrouter`) |
| `Kimi K2.6 TEE` | Chutes: `chutes/moonshotai/Kimi-K2.6-TEE` (`--chutes`) |
| `Kimi K3` | Moonshot API: `moonshot/kimi-k3` (`--moonshot`); DeepInfra: `deepinfra/moonshotai/Kimi-K3` (`--deepinfra`); KubeTEE: `kubetee/moonshotai/kimi-k3` (`--kubetee`); Engy: `engy/kimi-k3` (`--engy`); Moonmath ZRO: `moonmath/kimi-k3` (`--moonmath`); OpenRouter: `openrouter/moonshotai/kimi-k3` (`--openrouter`) |
...
| `o3` | OpenAI API: `openai/o3` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/o3` (`--openrouter`) |
| `o4-mini` | OpenAI API: `openai/o4-mini` (`--openai`); Azure OpenAI: ARM-verified transport, feature-gated admission; OpenRouter: `openrouter/openai/o4-mini` (`--openrouter`) |
...
| `Qwen3.6 35B A3B` | Engy: `engy/qwen3.6-35b-a3b` (`--engy`); DeepInfra: `deepinfra/Qwen/Qwen3.6-35B-A3B` (`--deepinfra`); OpenRouter: `openrouter/qwen/qwen3.6-35b-a3b` (`--openrouter`) |
| `Qwen3.6 27B TEE` | Chutes: `chutes/Qwen/Qwen3.6-27B-TEE` (`--chutes`); NEAR confidential inference: `near/Qwen/Qwen3.6-27B-FP8` (`--near`) |
| `Qwen3.8 27B` | Engy: `engy/qwen3.8-27b` (`--engy`); DeepInfra: `deepinfra/Qwen/Qwen3.8-27B` (`--deepinfra`); OpenRouter: `openrouter/qwen/qwen3.8-27b` (`--openrouter`) |
