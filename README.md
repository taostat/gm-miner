...
You bring your own provider API keys (Anthropic, OpenAI, Google, Chutes, Z.ai, or Bedrock/Azure behind
...
Your provider API keys (Anthropic, OpenAI, Google, Chutes, Z.ai) are baked into the miner container at
...
| `gmcli set-api-keys` | Persist provider API keys (Anthropic, OpenAI, Google, Chutes, Z.ai) |
