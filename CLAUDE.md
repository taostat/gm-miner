...
| `sources` | List the sourcing routes you can serve: a buyer product served from a cheaper upstream, with the buyer retail you settle on, whether a worker holds the upstream key, and whether you already offer it |
